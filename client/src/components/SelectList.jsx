...
const SelectList = ({lists, selected, setSelected, label, isDisabled}) => {
  return (
    <div className='w-full'>
      ...
      <Listbox value={selected} onChange={setSelected} disabled={isDisabled}>
        <div className='relative mt-1'>
          <Listbox.Button 
            className={`relative w-full cursor-default rounded bg-white pl-3 pr-10 text-left px-3 py-2.5 2xl:py-3 border border-gray-300 sm:text-sm ${isDisabled ? '' : ''}`}
          >
